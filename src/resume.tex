...
\item Incoming Software Engineering Intern for Summer 2022 on the Payments Infrastructure team
\end{rSubsection}

\begin{rSubsection}{Baskin School of Engineering}{\bf{Santa Cruz, CA}}{Group Tutor}{March 2022 - Current}
\item Group tutor for CSE 13s (Computer Systems and C Programming), a course focusing on computer systems and algorithm design
\item Duties include helping students with debugging code, grading exams, hosting section hours and course infrastructure
\end{rSubsection}
