...
\\ Bachelor of Science (B.S.) in Computer Science and Engineering\hfill %{\emph{GPA: 3.8/4.0}} 
...
\begin{rSubsection}{PayPal}{\bf{June 2022 - September 2022}}{Incoming Software Engineer Intern}{San Jose, CA }
...
\item Modifying the \href{https://github.com/salesforce/ai-economist}{Salesforce AI Economist tax model} to analyze scaling of apprenticeship learning under Professor David Lee
\item Adding actions and other variables to new and existing agents in order to model different styles of apprenticeship programs 
\end{rSubsection}

\begin{rSubsection}{Fox Factory}{\bf{September 2021 - January 2022}}{Embedded Software Engineer Intern}{Scotts Valley, CA }
...
\begin{rSubsection}{Diversified Medical Records Services}{\bf{April 2021 - September 2021}}{Software Engineer Intern}{Salt Lake City, UT }
